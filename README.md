# Growth Consulting — Real Estate Investing Website

A responsive multi-page website for **Growth Consulting**, a real estate investment firm established in 2021, headquartered in Arlington, Texas.
...
- **Color scheme:** Brown & gold (matching the Growth Consulting brand identity)
...
1. Create a new GitHub repository (e.g. `growth-consulting-website`).
2. Push all files to the `main` branch:
   ```bash
   git init
   git add .
   git commit -m "Initial commit — Growth Consulting website"
   git branch -M main
   git remote add origin https://github.com/YOUR_USERNAME/growth-consulting-website.git
   git push -u origin main
   ```
3. In your repo settings → **Pages** → set source to `main` branch, root folder.
4. Site will be live at `https://YOUR_USERNAME.github.io/growth-consulting-website/` within a minute or two.

For a custom domain (e.g. `growthconsulting.com`), add a `CNAME` file with your domain and configure DNS.
...
> **2131 N. Collins, Ste 433, Arlington, TX 76011**
...
MIT License — see `LICENSE` file. Logo and brand assets are property of Growth Consulting.

---

**Growth Consulting** · Building peace of mind, one property at a time.
